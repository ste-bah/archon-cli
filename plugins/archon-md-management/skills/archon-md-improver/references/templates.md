...
Describe the project structure so Archon understands where things live.
...
List important files that Archon should know about.
...
4. **Be useful**: Would this help a new Archon session understand the project?
