#!/usr/bin/env python3
"""Configuration loader for the hookify plugin (Archon port).

Loads and parses .archon/hookify/*.local.md rule files.
"""
...
def load_rules(event: Optional[str] = None) -> List[Rule]:
    """Load all hookify rules from the .archon/hookify directory.
    ...
    # Find all .archon/hookify/*.local.md rule files (relative to the
    # current working directory, i.e. the project root Archon runs in).
    pattern = os.path.join('.archon', 'hookify', '*.local.md')
