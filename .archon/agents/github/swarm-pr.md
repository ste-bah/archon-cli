...
# (claude-flow tool agent_spawn removed) { type: "tester", name: "Test Engineer" }
# (claude-flow tool agent_spawn removed) { type: "analyst", name: "Impact Analyzer" }
...
# (claude-flow tool coordination_sync removed) { swarmId: "pr-review-swarm" }
