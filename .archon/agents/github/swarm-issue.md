...
# (swarm tool removed) { topology: "hierarchical", maxAgents: 8 }
# (claude-flow tool agent_spawn removed) { type: "coordinator", name: "Issue Coordinator" }
# (claude-flow tool agent_spawn removed) { type: "analyst", name: "Issue Analyzer" }
# (claude-flow tool agent_spawn removed) { type: "coder", name: "Solution Developer" }
