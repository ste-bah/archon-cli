...
# (swarm tool removed) { topology: "star", maxAgents: 3 }
# (claude-flow tool agent_spawn removed) { type: "coordinator", name: "Issue Coordinator" }
# (claude-flow tool agent_spawn removed) { type: "researcher", name: "Requirements Analyst" }
...
[Single Message - Issue Lifecycle Management]:
  ...
  # (claude-flow tool agent_spawn removed) { type: "coordinator", name: "Issue Manager" }
  # (claude-flow tool agent_spawn removed) { type: "analyst", name: "Progress Tracker" }
  # (claude-flow tool agent_spawn removed) { type: "researcher", name: "Context Gatherer" }
