...
# (swarm tool removed) { topology: "mesh", maxAgents: 12 }
# (claude-flow tool agent_spawn removed) { type: "coordinator", name: "Workflow Coordinator" }
# (claude-flow tool agent_spawn removed) { type: "architect", name: "Pipeline Architect" }
# (claude-flow tool agent_spawn removed) { type: "coder", name: "Workflow Developer" }
# (claude-flow tool agent_spawn removed) { type: "tester", name: "CI/CD Tester" }
# (claude-flow tool agent_spawn removed) { type: "optimizer", name: "Performance Optimizer" }
# (claude-flow tool agent_spawn removed) { type: "monitor", name: "Automation Monitor" }
# (claude-flow tool agent_spawn removed) { type: "analyst", name: "Workflow Analyzer" }
