...
# (claude-flow tool agent_spawn removed) { type: "coordinator", name: "GitHub Coordinator" }
# (claude-flow tool agent_spawn removed) { type: "reviewer", name: "Code Reviewer" }
# (claude-flow tool agent_spawn removed) { type: "tester", name: "QA Agent" }

// Execute GitHub workflow with coordination
# (claude-flow tool task_orchestrate removed) { task: "GitHub workflow", strategy: "parallel" }
```