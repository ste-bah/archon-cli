...
# (removed: claude-flow hooks pre-task --description "Structural mapping - Domain detection")
...
# (removed: claude-flow hooks notify --message "Structural mapping complete: 23 components, 5-level hierarchy, 87% completeness")
```
...
```bash
# 1. Initialize
# (removed: claude-flow hooks pre-task --description "Structural mapping - Software architecture")
...
```bash
# 1. Initialize
# (removed: claude-flow hooks pre-task --description "Structural mapping - Business architecture")
...
```bash
# 1. Initialize
# (removed: claude-flow hooks pre-task --description "Structural mapping - Research architecture")
