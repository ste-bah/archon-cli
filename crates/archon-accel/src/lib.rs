...
pub use placement::{
    marker_cpu_fallback_env, plan_marker_ingest, plan_placement, ConsumerKind, ConsumerRequest,
    DeviceOverrides, ModelFootprintTable, Placement, PlacementPlan, Precision, SuryaTier,
};
