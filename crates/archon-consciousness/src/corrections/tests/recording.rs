...
#[test]
fn derived_rule_id_is_stable_for_normalized_content() {
    assert_eq!(
        derived_rule_id("use edit before modifying config files"),
        "rule:correction:aa0a119c6db7ed7da6a9e3ffa4728b14ff45387147ca559ce2eabae01d2829d6"
    );
    assert_eq!(
        derived_rule_id(&normalize_correction_content(
