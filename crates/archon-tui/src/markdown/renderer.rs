//! Full-document markdown renderer using pulldown-cmark.
//!
//! Relocated from `src/markdown.rs` (full-renderer section, lines 13-339 +
//! helper) per REM-2c. Private to the `markdown` module; public entry via
//! [`render_markdown`] re-exported from `markdown::mod`.
