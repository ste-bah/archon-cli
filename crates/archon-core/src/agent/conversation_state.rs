//! Conversation state for an agent turn.
//!
//! Split from `types.rs` for the 500-line ceiling; `types.rs` keeps the event
//! and configuration types, this keeps the mutable per-turn state they act on.
