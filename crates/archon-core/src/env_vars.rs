...
pub const KNOWN_ARCHON_VARS: &[&str] = &[
    ...
    // Memory / embeddings
    "ARCHON_DOCS_EMBEDDING_BASE_URL",
    "ARCHON_DOCS_EMBEDDING_LOAD_TIMEOUT_SECS",
    "ARCHON_DOCS_EMBEDDING_MODEL",
    "ARCHON_DOCS_EMBEDDING_PROVIDER",
    "ARCHON_DOCS_EMBEDDING_TIMEOUT_SECS",
