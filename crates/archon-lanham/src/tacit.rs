//! Tacit rhetorical patterns (alliteration, polyptoton, chiasmus, antithesis,
//! anaphora, isocolon, climax).

use crate::lexical::{get_content_words, rough_stem};
use crate::{WHITESPACE, char_len, split_sentences, tokenize};
use regex::Regex;
