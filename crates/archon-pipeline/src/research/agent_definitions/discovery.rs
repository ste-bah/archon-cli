...
pub(super) const LITERATURE_MAPPER: ResearchAgent = ResearchAgent {
...
pub(super) const SOURCE_TIER_CLASSIFIER: ResearchAgent = ResearchAgent {
...
pub(super) const CITATION_EXTRACTOR: ResearchAgent = ResearchAgent {
...
pub(super) const CONTEXT_TIER_MANAGER: ResearchAgent = ResearchAgent {
