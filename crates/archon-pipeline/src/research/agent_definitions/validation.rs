...
pub(super) const ETHICS_REVIEWER: ResearchAgent = ResearchAgent {
        key: "ethics-reviewer",
...
pub(super) const ADVERSARIAL_REVIEWER: ResearchAgent = ResearchAgent {
...
pub(super) const CONFIDENCE_QUANTIFIER: ResearchAgent = ResearchAgent {
...
pub(super) const CITATION_VALIDATOR: ResearchAgent = ResearchAgent {
...
pub(super) const REPRODUCIBILITY_CHECKER: ResearchAgent = ResearchAgent {
...
pub(super) const APA_CITATION_SPECIALIST: ResearchAgent = ResearchAgent {
...
pub(super) const CITATION_RECONCILER: ResearchAgent = ResearchAgent {
...
pub(super) const CONSISTENCY_VALIDATOR: ResearchAgent = ResearchAgent {
...
pub(super) const QUALITY_ASSESSOR: ResearchAgent = ResearchAgent {
...
pub(super) const BIAS_DETECTOR: ResearchAgent = ResearchAgent {
        key: "bias-detector",
...
pub(super) const FILE_LENGTH_MANAGER: ResearchAgent = ResearchAgent {
