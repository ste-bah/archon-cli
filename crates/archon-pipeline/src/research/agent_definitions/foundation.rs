...
pub(in super::super) const STEP_BACK_ANALYZER: ResearchAgent = ResearchAgent {
...
pub(in super::super) const SELF_ASK_DECOMPOSER: ResearchAgent = ResearchAgent {
...
pub(in super::super) const AMBIGUITY_CLARIFIER: ResearchAgent = ResearchAgent {
...
pub(in super::super) const RESEARCH_PLANNER: ResearchAgent = ResearchAgent {
...
pub(in super::super) const CONSTRUCT_DEFINER: ResearchAgent = ResearchAgent {
...
pub(in super::super) const DISSERTATION_ARCHITECT: ResearchAgent = ResearchAgent {
