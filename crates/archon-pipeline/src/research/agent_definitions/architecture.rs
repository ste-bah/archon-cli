...
pub(super) const THEORETICAL_FRAMEWORK_ANALYST: ResearchAgent = ResearchAgent {
...
pub(super) const CONTRADICTION_ANALYZER: ResearchAgent = ResearchAgent {
...
pub(super) const GAP_HUNTER: ResearchAgent = ResearchAgent {
        key: "gap-hunter",
...
pub(super) const RISK_ANALYST: ResearchAgent = ResearchAgent {
        key: "risk-analyst",
