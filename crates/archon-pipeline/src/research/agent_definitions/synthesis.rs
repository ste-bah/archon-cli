...
pub(in super::super) const EVIDENCE_SYNTHESIZER: ResearchAgent = ResearchAgent {
...
pub(in super::super) const PATTERN_ANALYST: ResearchAgent = ResearchAgent {
    key: "pattern-analyst",
...
pub(in super::super) const THEMATIC_SYNTHESIZER: ResearchAgent = ResearchAgent {
...
pub(in super::super) const THEORY_BUILDER: ResearchAgent = ResearchAgent {
    key: "theory-builder",
...
pub(in super::super) const OPPORTUNITY_IDENTIFIER: ResearchAgent = ResearchAgent {
