...
pub(super) const HYPOTHESIS_GENERATOR: ResearchAgent = ResearchAgent {
...
pub(super) const MODEL_ARCHITECT: ResearchAgent = ResearchAgent {
        key: "model-architect",
...
pub(super) const ANALYSIS_PLANNER: ResearchAgent = ResearchAgent {
...
pub(super) const SAMPLING_STRATEGIST: ResearchAgent = ResearchAgent {
...
pub(super) const INSTRUMENT_DEVELOPER: ResearchAgent = ResearchAgent {
...
pub(super) const VALIDITY_GUARDIAN: ResearchAgent = ResearchAgent {
...
pub(super) const METHODOLOGY_SCANNER: ResearchAgent = ResearchAgent {
...
pub(super) const METHODOLOGY_WRITER: ResearchAgent = ResearchAgent {
