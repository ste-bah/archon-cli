...
pub(super) const INTRODUCTION_WRITER: ResearchAgent = ResearchAgent {
...
pub(super) const LITERATURE_REVIEW_WRITER: ResearchAgent = ResearchAgent {
...
pub(super) const RESULTS_WRITER: ResearchAgent = ResearchAgent {
        key: "results-writer",
...
pub(super) const DISCUSSION_WRITER: ResearchAgent = ResearchAgent {
...
pub(super) const CONCLUSION_WRITER: ResearchAgent = ResearchAgent {
...
pub(super) const ABSTRACT_WRITER: ResearchAgent = ResearchAgent {
        key: "abstract-writer",
