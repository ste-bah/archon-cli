...
pub static GAMETHEORY_AGENTS: &[GameTheoryAgent] = &[
    GameTheoryAgent {
        ...
        memory_keys: &[],
        output_artifacts: &[],
        prompt_source_path: "docs2/gametheory/asymmetric-info-detective.md",
    ...
    GameTheoryAgent {
        ...
        memory_keys: &[],
        output_artifacts: &[],
        prompt_source_path: "docs2/gametheory/auction-strategist.md",
        tool_access: &[GameTheoryToolAccess::Read, GameTheoryToolAccess::Grep, GameTheoryToolAccess::Glob],
        model: "opus",
        condition: None,
        depends_on: &[],
    ...
    GameTheoryAgent {
        ...
        memory_keys: &[],
        output_artifacts: &[],
        prompt_source_path: "docs2/gametheory/backward-induction-solver.md",
        tool_access: &[GameTheoryToolAccess::Read, GameTheoryToolAccess::Grep, GameTheoryToolAccess::Glob],
        model: "opus",
        condition: None,
        depends_on: &[],
    ...
    GameTheoryAgent {
        ...
        memory_keys: &[],
        output_artifacts: &[],
        prompt_source_path: "docs2/gametheory/banzhaf-power-auditor.md",
        tool_access: &[GameTheoryToolAccess::Read, GameTheoryToolAccess::Grep, GameTheoryToolAccess::Glob],
        model: "opus",
        condition: None,
        depends_on: &[],
    ...
    GameTheoryAgent {
        ...
        memory_keys: &[],
        output_artifacts: &[],
        prompt_source_path: "docs2/gametheory/battle-of-sexes-coordinator.md",
        tool_access: &[GameTheoryToolAccess::Read, GameTheoryToolAccess::Grep, GameTheoryToolAccess::Glob],
        model: "opus",
        condition: None,
        depends_on: &[],
    ...
    GameTheoryAgent {
        ...
        memory_keys: &[],
        output_artifacts: &[],
        prompt_source_path: "docs2/gametheory/bayesian-belief-updater.md",
        tool_access: &[GameTheoryToolAccess::Read, GameTheoryToolAccess::Grep, GameTheoryToolAccess::Glob],
        model: "opus",
        condition: None,
        depends_on: &[],
    ...
    GameTheoryAgent {
        ...
        memory_keys: &[],
        output_artifacts: &[],
        prompt_source_path: "docs2/gametheory/bayesian-equilibrium-analyst.md",
        tool_access: &[GameTheoryToolAccess::Read, GameTheoryToolAccess::Grep, GameTheoryToolAccess::Glob],
        model: "opus",
        condition: None,
        depends_on: &[],
    ...
    GameTheoryAgent {
        ...
        memory_keys: &[],
        output_artifacts: &[],
        prompt_source_path: "docs2/gametheory/behavioral-bias-detector.md",
        tool_access: &[GameTheoryToolAccess::Read, GameTheoryToolAccess::Grep, GameTheoryToolAccess::Glob],
        model: "opus",
        condition: None,
        depends_on: &[],
    ...
    GameTheoryAgent {
        ...
        memory_keys: &[],
        output_artifacts: &[],
        prompt_source_path: "docs2/gametheory/bluff-and-deception-analyst.md",
        tool_access: &[GameTheoryToolAccess::Read, GameTheoryToolAccess::Grep, GameTheoryToolAccess::Glob],
        model: "opus",
        condition: None,
        depends_on: &[],
    ...
    GameTheoryAgent {
        ...
        memory_keys: &[],
        output_artifacts: &[],
        prompt_source_path: "docs2/gametheory/brinkmanship-tactician.md",
        tool_access: &[GameTheoryToolAccess::Read, GameTheoryToolAccess::Grep, GameTheoryToolAccess::Glob],
        model: "opus",
        condition: None,
        depends_on: &[],
    ...
    GameTheoryAgent {
        ...
        memory_keys: &[],
        output_artifacts: &[],
        prompt_source_path: "docs2/gametheory/business-strategy-gamifier.md",
    ...
    GameTheoryAgent {
        ...
        memory_keys: &[],
        output_artifacts: &[],
        prompt_source_path: "docs2/gametheory/centipede-game-analyst.md",
        tool_access: &[GameTheoryToolAccess::Read, GameTheoryToolAccess::Grep, GameTheoryToolAccess::Glob],
        model: "opus",
        condition: None,
        depends_on: &[],
    ...
    GameTheoryAgent {
        ...
        memory_keys: &[],
        output_artifacts: &[],
        prompt_source_path: "docs2/gametheory/cheap-talk-evaluator.md",
        tool_access: &[GameTheoryToolAccess::Read, GameTheoryToolAccess::Grep, GameTheoryToolAccess::Glob],
        model: "opus",
        condition: None,
        depends_on: &[],
    ...
    GameTheoryAgent {
        ...
        memory_keys: &[],
        output_artifacts: &[],
        prompt_source_path: "docs2/gametheory/chicken-brinksmanship-tactician.md",
        tool_access: &[GameTheoryToolAccess::Read, GameTheoryToolAccess::Grep, GameTheoryToolAccess::Glob],
        model: "opus",
        condition: None,
        depends_on: &[],
    ...
    GameTheoryAgent {
        ...
        memory_keys: &[],
        output_artifacts: &[],
        prompt_source_path: "docs2/gametheory/coalition-formation-strategist.md",
        tool_access: &[GameTheoryToolAccess::Read, GameTheoryToolAccess::Grep, GameTheoryToolAccess::Glob],
        model: "opus",
        condition: None,
        depends_on: &[],
    ...
    GameTheoryAgent {
        ...
        memory_keys: &[],
        output_artifacts: &[],
        prompt_source_path: "docs2/gametheory/cohesion-discipline-devotion-auditor.md",
        tool_access: &[GameTheoryToolAccess::Read, GameTheoryToolAccess::Grep, GameTheoryToolAccess::Glob],
        model: "opus",
        condition: None,
        depends_on: &[],
    ...
    GameTheoryAgent {
        ...
        memory_keys: &[],
        output_artifacts: &[],
        prompt_source_path: "docs2/gametheory/commitment-device-engineer.md",
        tool_access: &[GameTheoryToolAccess::Read, GameTheoryToolAccess::Grep, GameTheoryToolAccess::Glob],
        model: "opus",
        condition: None,
        depends_on: &[],
    ...
    GameTheoryAgent {
        ...
        memory_keys: &[],
        output_artifacts: &[],
        prompt_source_path: "docs2/gametheory/common-knowledge-analyst.md",
        tool_access: &[GameTheoryToolAccess::Read, GameTheoryToolAccess::Grep, GameTheoryToolAccess::Glob],
        model: "opus",
        condition: None,
        depends_on: &[],
    ...
    GameTheoryAgent {
        ...
        memory_keys: &[],
        output_artifacts: &[],
        prompt_source_path: "docs2/gametheory/conflict-resolution-theorist.md",
        tool_access: &[GameTheoryToolAccess::Read, GameTheoryToolAccess::Grep, GameTheoryToolAccess::Glob],
        model: "opus",
        condition: None,
        depends_on: &[],
    ...
    GameTheoryAgent {
        ...
        memory_keys: &[],
        output_artifacts: &[],
        prompt_source_path: "docs2/gametheory/cooperation-emergence-analyst.md",
        tool_access: &[GameTheoryToolAccess::Read, GameTheoryToolAccess::Grep, GameTheoryToolAccess::Glob],
        model: "opus",
        condition: None,
        depends_on: &[],
    ...
    GameTheoryAgent {
        ...
        memory_keys: &[],
        output_artifacts: &[],
        prompt_source_path: "docs2/gametheory/coopetition-strategist.md",
        tool_access: &[GameTheoryToolAccess::Read, GameTheoryToolAccess::Grep, GameTheoryToolAccess::Glob],
        model: "opus",
        condition: None,
        depends_on: &[],
    ...
    GameTheoryAgent {
        ...
        memory_keys: &[],
        output_artifacts: &[],
        prompt_source_path: "docs2/gametheory/core-stability-analyst.md",
        tool_access: &[GameTheoryToolAccess::Read, GameTheoryToolAccess::Grep, GameTheoryToolAccess::Glob],
        model: "opus",
        condition: None,
        depends_on: &[],
    ...
    GameTheoryAgent {
        ...
        memory_keys: &[],
        output_artifacts: &[],
        prompt_source_path: "docs2/gametheory/correlated-equilibrium-designer.md",
        tool_access: &[GameTheoryToolAccess::Read, GameTheoryToolAccess::Grep, GameTheoryToolAccess::Glob],
        model: "opus",
        condition: None,
        depends_on: &[],
    ...
    GameTheoryAgent {
        ...
        memory_keys: &[],
        output_artifacts: &[],
        prompt_source_path: "docs2/gametheory/counterfactual-simulator.md",
        tool_access: &[GameTheoryToolAccess::Read, GameTheoryToolAccess::Grep, GameTheoryToolAccess::Glob],
        model: "opus",
        condition: None,
        depends_on: &[],
    ...
    GameTheoryAgent {
        ...
        memory_keys: &[],
        output_artifacts: &[],
        prompt_source_path: "docs2/gametheory/credibility-assessor.md",
        tool_access: &[GameTheoryToolAccess::Read, GameTheoryToolAccess::Grep, GameTheoryToolAccess::Glob],
        model: "opus",
        condition: None,
        depends_on: &[],
    ...
    GameTheoryAgent {
        ...
        memory_keys: &[],
        output_artifacts: &[],
        prompt_source_path: "docs2/gametheory/deterrence-theorist.md",
        tool_access: &[GameTheoryToolAccess::Read, GameTheoryToolAccess::Grep, GameTheoryToolAccess::Glob],
        model: "opus",
        condition: None,
        depends_on: &[],
    ...
    GameTheoryAgent {
        ...
        memory_keys: &[],
        output_artifacts: &[],
        prompt_source_path: "docs2/gametheory/dialectic-tension-mapper.md",
        tool_access: &[GameTheoryToolAccess::Read, GameTheoryToolAccess::Grep, GameTheoryToolAccess::Glob],
        model: "opus",
        condition: None,
        depends_on: &[],
    ...
    GameTheoryAgent {
        ...
        memory_keys: &[],
        output_artifacts: &[],
        prompt_source_path: "docs2/gametheory/diaspora-dynamics-analyst.md",
        tool_access: &[GameTheoryToolAccess::Read, GameTheoryToolAccess::Grep, GameTheoryToolAccess::Glob],
        model: "opus",
        condition: None,
        depends_on: &[],
    ...
    GameTheoryAgent {
        ...
        memory_keys: &[],
        output_artifacts: &[],
        prompt_source_path: "docs2/gametheory/dominant-strategy-identifier.md",
        tool_access: &[GameTheoryToolAccess::Read, GameTheoryToolAccess::Grep, GameTheoryToolAccess::Glob],
        model: "opus",
        condition: None,
        depends_on: &[],
    ...
    GameTheoryAgent {
        ...
        memory_keys: &[],
        output_artifacts: &[],
        prompt_source_path: "docs2/gametheory/elite-overproduction-diagnostician.md",
        tool_access: &[GameTheoryToolAccess::Read, GameTheoryToolAccess::Grep, GameTheoryToolAccess::Glob],
        model: "opus",
        condition: None,
        depends_on: &[],
    ...
    GameTheoryAgent {
        ...
        memory_keys: &[],
        output_artifacts: &[],
        prompt_source_path: "docs2/gametheory/equilibrium-selector.md",
        tool_access: &[GameTheoryToolAccess::Read, GameTheoryToolAccess::Grep, GameTheoryToolAccess::Glob],
        model: "opus",
        condition: None,
        depends_on: &[],
    ...
    GameTheoryAgent {
        ...
        memory_keys: &[],
        output_artifacts: &[],
        prompt_source_path: "docs2/gametheory/ess-detector.md",
        tool_access: &[GameTheoryToolAccess::Read, GameTheoryToolAccess::Grep, GameTheoryToolAccess::Glob],
        model: "opus",
        condition: None,
        depends_on: &[],
    ...
    GameTheoryAgent {
        ...
        memory_keys: &[],
        output_artifacts: &[],
        prompt_source_path: "docs2/gametheory/evolutionary-strategy-analyst.md",
        tool_access: &[GameTheoryToolAccess::Read, GameTheoryToolAccess::Grep, GameTheoryToolAccess::Glob],
        model: "opus",
        condition: None,
        depends_on: &[],
    ...
    GameTheoryAgent {
        ...
        memory_keys: &[],
        output_artifacts: &[],
        prompt_source_path: "docs2/gametheory/extensive-form-modeler.md",
        tool_access: &[GameTheoryToolAccess::Read, GameTheoryToolAccess::Grep, GameTheoryToolAccess::Glob],
        model: "opus",
        condition: None,
        depends_on: &[],
    ...
    GameTheoryAgent {
        ...
        memory_keys: &[],
        output_artifacts: &[],
        prompt_source_path: "docs2/gametheory/fairness-preferences-analyst.md",
        tool_access: &[GameTheoryToolAccess::Read, GameTheoryToolAccess::Grep, GameTheoryToolAccess::Glob],
        model: "opus",
        condition: None,
        depends_on: &[],
    ...
    GameTheoryAgent {
        ...
        memory_keys: &[],
        output_artifacts: &[],
        prompt_source_path: "docs2/gametheory/father-son-dynastic-analyst.md",
        tool_access: &[GameTheoryToolAccess::Read, GameTheoryToolAccess::Grep, GameTheoryToolAccess::Glob],
        model: "opus",
        condition: None,
        depends_on: &[],
    ...
    GameTheoryAgent {
        ...
        memory_keys: &[],
        output_artifacts: &[],
        prompt_source_path: "docs2/gametheory/first-mover-analyst.md",
        tool_access: &[GameTheoryToolAccess::Read, GameTheoryToolAccess::Grep, GameTheoryToolAccess::Glob],
        model: "opus",
        condition: None,
        depends_on: &[],
    ...
    GameTheoryAgent {
        ...
        memory_keys: &[],
        output_artifacts: &[],
        prompt_source_path: "docs2/gametheory/focal-point-identifier.md",
        tool_access: &[GameTheoryToolAccess::Read, GameTheoryToolAccess::Grep, GameTheoryToolAccess::Glob],
        model: "opus",
        condition: None,
        depends_on: &[],
    ...
    GameTheoryAgent {
        ...
        memory_keys: &[],
        output_artifacts: &[],
        prompt_source_path: "docs2/gametheory/folk-theorem-applier.md",
        tool_access: &[GameTheoryToolAccess::Read, GameTheoryToolAccess::Grep, GameTheoryToolAccess::Glob],
        model: "opus",
        condition: None,
        depends_on: &[],
    ...
    GameTheoryAgent {
        ...
        memory_keys: &[],
        output_artifacts: &[],
        prompt_source_path: "docs2/gametheory/game-classifier.md",
    ...
    GameTheoryAgent {
        ...
        memory_keys: &[],
        output_artifacts: &[],
        prompt_source_path: "docs2/gametheory/game-tree-archaeologist.md",
        tool_access: &[GameTheoryToolAccess::Read, GameTheoryToolAccess::Grep, GameTheoryToolAccess::Glob],
        model: "opus",
        condition: None,
        depends_on: &[],
    ...
    GameTheoryAgent {
        ...
        memory_keys: &[],
        output_artifacts: &[],
        prompt_source_path: "docs2/gametheory/geopolitical-game-analyst.md",
        tool_access: &[GameTheoryToolAccess::Read, GameTheoryToolAccess::Grep, GameTheoryToolAccess::Glob, GameTheoryToolAccess::WebSearch],
        model: "opus",
        condition: None,
        depends_on: &[],
    ...
    GameTheoryAgent {
        ...
        memory_keys: &[],
        output_artifacts: &[],
        prompt_source_path: "docs2/gametheory/incentive-compatibility-auditor.md",
        tool_access: &[GameTheoryToolAccess::Read, GameTheoryToolAccess::Grep, GameTheoryToolAccess::Glob],
        model: "opus",
        condition: None,
        depends_on: &[],
    ...
    GameTheoryAgent {
        ...
        memory_keys: &[],
        output_artifacts: &[],
        prompt_source_path: "docs2/gametheory/information-structure-mapper.md",
    ...
    GameTheoryAgent {
        ...
        memory_keys: &[],
        output_artifacts: &[],
        prompt_source_path: "docs2/gametheory/legitimacy-crisis-analyst.md",
        tool_access: &[GameTheoryToolAccess::Read, GameTheoryToolAccess::Grep, GameTheoryToolAccess::Glob],
        model: "opus",
        condition: None,
        depends_on: &[],
    ...
    GameTheoryAgent {
        ...
        memory_keys: &[],
        output_artifacts: &[],
        prompt_source_path: "docs2/gametheory/level-k-reasoning-profiler.md",
        tool_access: &[GameTheoryToolAccess::Read, GameTheoryToolAccess::Grep, GameTheoryToolAccess::Glob],
        model: "opus",
        condition: None,
        depends_on: &[],
    ...
    GameTheoryAgent {
        ...
        memory_keys: &[],
        output_artifacts: &[],
        prompt_source_path: "docs2/gametheory/loss-aversion-analyst.md",
        tool_access: &[GameTheoryToolAccess::Read, GameTheoryToolAccess::Grep, GameTheoryToolAccess::Glob],
        model: "opus",
        condition: None,
        depends_on: &[],
    ...
    GameTheoryAgent {
        ...
        memory_keys: &[],
        output_artifacts: &[],
        prompt_source_path: "docs2/gametheory/market-competition-modeler.md",
        tool_access: &[GameTheoryToolAccess::Read, GameTheoryToolAccess::Grep, GameTheoryToolAccess::Glob],
        model: "opus",
        condition: None,
        depends_on: &[],
    ...
    GameTheoryAgent {
        ...
        memory_keys: &[],
        output_artifacts: &[],
        prompt_source_path: "docs2/gametheory/matching-market-designer.md",
        tool_access: &[GameTheoryToolAccess::Read, GameTheoryToolAccess::Grep, GameTheoryToolAccess::Glob],
        model: "opus",
        condition: None,
        depends_on: &[],
    ...
    GameTheoryAgent {
        ...
        memory_keys: &[],
        output_artifacts: &[],
        prompt_source_path: "docs2/gametheory/matching-pennies-randomizer.md",
        tool_access: &[GameTheoryToolAccess::Read, GameTheoryToolAccess::Grep, GameTheoryToolAccess::Glob],
        model: "opus",
        condition: None,
        depends_on: &[],
    ...
    GameTheoryAgent {
        ...
        memory_keys: &[],
        output_artifacts: &[],
        prompt_source_path: "docs2/gametheory/mechanism-designer.md",
        tool_access: &[GameTheoryToolAccess::Read, GameTheoryToolAccess::Grep, GameTheoryToolAccess::Glob],
        model: "opus",
        condition: None,
        depends_on: &[],
    ...
    GameTheoryAgent {
        ...
        memory_keys: &[],
        output_artifacts: &[],
        prompt_source_path: "docs2/gametheory/meta-game-designer.md",
        tool_access: &[GameTheoryToolAccess::Read, GameTheoryToolAccess::Grep, GameTheoryToolAccess::Glob],
        model: "opus",
        condition: None,
        depends_on: &[],
    ...
    GameTheoryAgent {
        ...
        memory_keys: &[],
        output_artifacts: &[],
        prompt_source_path: "docs2/gametheory/mixed-strategy-calculator.md",
        tool_access: &[GameTheoryToolAccess::Read, GameTheoryToolAccess::Grep, GameTheoryToolAccess::Glob],
        model: "opus",
        condition: None,
        depends_on: &[],
    ...
    GameTheoryAgent {
        ...
        memory_keys: &[],
        output_artifacts: &[],
        prompt_source_path: "docs2/gametheory/myth-making-strategist.md",
        tool_access: &[GameTheoryToolAccess::Read, GameTheoryToolAccess::Grep, GameTheoryToolAccess::Glob],
        model: "opus",
        condition: None,
        depends_on: &[],
    ...
    GameTheoryAgent {
        ...
        memory_keys: &[],
        output_artifacts: &[],
        prompt_source_path: "docs2/gametheory/nash-equilibrium-finder.md",
        tool_access: &[GameTheoryToolAccess::Read, GameTheoryToolAccess::Grep, GameTheoryToolAccess::Glob],
        model: "opus",
        condition: None,
        depends_on: &[],
    ...
    GameTheoryAgent {
        ...
        memory_keys: &[],
        output_artifacts: &[],
        prompt_source_path: "docs2/gametheory/negotiation-strategist.md",
        tool_access: &[GameTheoryToolAccess::Read, GameTheoryToolAccess::Grep, GameTheoryToolAccess::Glob],
        model: "opus",
        condition: None,
        depends_on: &[],
    ...
    GameTheoryAgent {
        ...
        memory_keys: &[],
        output_artifacts: &[],
        prompt_source_path: "docs2/gametheory/nucleolus-calculator.md",
        tool_access: &[GameTheoryToolAccess::Read, GameTheoryToolAccess::Grep, GameTheoryToolAccess::Glob],
        model: "opus",
        condition: None,
        depends_on: &[],
    ...
    GameTheoryAgent {
        ...
        memory_keys: &[],
        output_artifacts: &[],
        prompt_source_path: "docs2/gametheory/payoff-elicitor.md",
    ...
    GameTheoryAgent {
        ...
        memory_keys: &[],
        output_artifacts: &[],
        prompt_source_path: "docs2/gametheory/payoff-matrix-builder.md",
        tool_access: &[GameTheoryToolAccess::Read, GameTheoryToolAccess::Grep, GameTheoryToolAccess::Glob],
        model: "opus",
        condition: None,
        depends_on: &[],
    ...
    GameTheoryAgent {
        ...
        memory_keys: &[],
        output_artifacts: &[],
        prompt_source_path: "docs2/gametheory/poor-conquers-rich-analyst.md",
        tool_access: &[GameTheoryToolAccess::Read, GameTheoryToolAccess::Grep, GameTheoryToolAccess::Glob],
        model: "opus",
        condition: None,
        depends_on: &[],
    ...
    GameTheoryAgent {
        ...
        memory_keys: &[],
        output_artifacts: &[],
        prompt_source_path: "docs2/gametheory/power-transition-analyst.md",
        tool_access: &[GameTheoryToolAccess::Read, GameTheoryToolAccess::Grep, GameTheoryToolAccess::Glob],
        model: "opus",
        condition: None,
        depends_on: &[],
    ...
    GameTheoryAgent {
        ...
        memory_keys: &[],
        output_artifacts: &[],
        prompt_source_path: "docs2/gametheory/prisoners-dilemma-detector.md",
        tool_access: &[GameTheoryToolAccess::Read, GameTheoryToolAccess::Grep, GameTheoryToolAccess::Glob],
        model: "opus",
        condition: None,
        depends_on: &[],
    ...
    GameTheoryAgent {
        ...
        memory_keys: &[],
        output_artifacts: &[],
        prompt_source_path: "docs2/gametheory/propaganda-detector.md",
        tool_access: &[GameTheoryToolAccess::Read, GameTheoryToolAccess::Grep, GameTheoryToolAccess::Glob, GameTheoryToolAccess::WebSearch],
        model: "opus",
        condition: None,
        depends_on: &[],
    ...
    GameTheoryAgent {
        ...
        memory_keys: &[],
        output_artifacts: &[],
        prompt_source_path: "docs2/gametheory/public-goods-diagnostician.md",
        tool_access: &[GameTheoryToolAccess::Read, GameTheoryToolAccess::Grep, GameTheoryToolAccess::Glob],
        model: "opus",
        condition: None,
        depends_on: &[],
    ...
    GameTheoryAgent {
        ...
        memory_keys: &[],
        output_artifacts: &[],
        prompt_source_path: "docs2/gametheory/quantal-response-modeler.md",
        tool_access: &[GameTheoryToolAccess::Read, GameTheoryToolAccess::Grep, GameTheoryToolAccess::Glob],
        model: "opus",
        condition: None,
        depends_on: &[],
    ...
    GameTheoryAgent {
        ...
        memory_keys: &[],
        output_artifacts: &[],
        prompt_source_path: "docs2/gametheory/reputation-game-modeler.md",
        tool_access: &[GameTheoryToolAccess::Read, GameTheoryToolAccess::Grep, GameTheoryToolAccess::Glob],
        model: "opus",
        condition: None,
        depends_on: &[],
    ...
    GameTheoryAgent {
        ...
        memory_keys: &[],
        output_artifacts: &[],
        prompt_source_path: "docs2/gametheory/revenue-equivalence-analyst.md",
        tool_access: &[GameTheoryToolAccess::Read, GameTheoryToolAccess::Grep, GameTheoryToolAccess::Glob],
        model: "opus",
        condition: None,
        depends_on: &[],
    ...
    GameTheoryAgent {
        ...
        memory_keys: &[],
        output_artifacts: &[],
        prompt_source_path: "docs2/gametheory/screening-mechanism-designer.md",
        tool_access: &[GameTheoryToolAccess::Read, GameTheoryToolAccess::Grep, GameTheoryToolAccess::Glob],
        model: "opus",
        condition: None,
        depends_on: &[],
    ...
    GameTheoryAgent {
        ...
        memory_keys: &[],
        output_artifacts: &[],
        prompt_source_path: "docs2/gametheory/shapley-value-calculator.md",
        tool_access: &[GameTheoryToolAccess::Read, GameTheoryToolAccess::Grep, GameTheoryToolAccess::Glob],
        model: "opus",
        condition: None,
        depends_on: &[],
    ...
    GameTheoryAgent {
        ...
        memory_keys: &[],
        output_artifacts: &[],
        prompt_source_path: "docs2/gametheory/signaling-game-analyst.md",
        tool_access: &[GameTheoryToolAccess::Read, GameTheoryToolAccess::Grep, GameTheoryToolAccess::Glob],
        model: "opus",
        condition: None,
        depends_on: &[],
    ...
    GameTheoryAgent {
        ...
        memory_keys: &[],
        output_artifacts: &[],
        prompt_source_path: "docs2/gametheory/social-interaction-gamifier.md",
        tool_access: &[GameTheoryToolAccess::Read, GameTheoryToolAccess::Grep, GameTheoryToolAccess::Glob],
        model: "opus",
        condition: None,
        depends_on: &[],
    ...
    GameTheoryAgent {
        ...
        memory_keys: &[],
        output_artifacts: &[],
        prompt_source_path: "docs2/gametheory/stag-hunt-analyst.md",
        tool_access: &[GameTheoryToolAccess::Read, GameTheoryToolAccess::Grep, GameTheoryToolAccess::Glob],
        model: "opus",
        condition: None,
        depends_on: &[],
    ...
    GameTheoryAgent {
        ...
        memory_keys: &[],
        output_artifacts: &[],
        prompt_source_path: "docs2/gametheory/stochastic-game-analyst.md",
        tool_access: &[GameTheoryToolAccess::Read, GameTheoryToolAccess::Grep, GameTheoryToolAccess::Glob],
        model: "opus",
        condition: None,
        depends_on: &[],
    ...
    GameTheoryAgent {
        ...
        memory_keys: &[],
        output_artifacts: &[],
        prompt_source_path: "docs2/gametheory/strategy-space-enumerator.md",
        tool_access: &[GameTheoryToolAccess::Read, GameTheoryToolAccess::Grep, GameTheoryToolAccess::Glob],
        model: "opus",
        condition: None,
        depends_on: &[],
    ...
    GameTheoryAgent {
        ...
        memory_keys: &[],
        output_artifacts: &[],
        prompt_source_path: "docs2/gametheory/subgame-perfect-analyzer.md",
        tool_access: &[GameTheoryToolAccess::Read, GameTheoryToolAccess::Grep, GameTheoryToolAccess::Glob],
        model: "opus",
        condition: None,
        depends_on: &[],
    ...
    GameTheoryAgent {
        ...
        memory_keys: &[],
        output_artifacts: &[],
        prompt_source_path: "docs2/gametheory/threat-credibility-assessor.md",
        tool_access: &[GameTheoryToolAccess::Read, GameTheoryToolAccess::Grep, GameTheoryToolAccess::Glob],
        model: "opus",
        condition: None,
        depends_on: &[],
    ...
    GameTheoryAgent {
        ...
        memory_keys: &[],
        output_artifacts: &[],
        prompt_source_path: "docs2/gametheory/tit-for-tat-strategist.md",
        tool_access: &[GameTheoryToolAccess::Read, GameTheoryToolAccess::Grep, GameTheoryToolAccess::Glob],
        model: "opus",
        condition: None,
        depends_on: &[],
    ...
    GameTheoryAgent {
        ...
        memory_keys: &[],
        output_artifacts: &[],
        prompt_source_path: "docs2/gametheory/tragedy-commons-analyst.md",
        tool_access: &[GameTheoryToolAccess::Read, GameTheoryToolAccess::Grep, GameTheoryToolAccess::Glob],
        model: "opus",
        condition: None,
        depends_on: &[],
    ...
    GameTheoryAgent {
        ...
        memory_keys: &[],
        output_artifacts: &[],
        prompt_source_path: "docs2/gametheory/trembling-hand-refiner.md",
        tool_access: &[GameTheoryToolAccess::Read, GameTheoryToolAccess::Grep, GameTheoryToolAccess::Glob],
        model: "opus",
        condition: None,
        depends_on: &[],
    ...
    GameTheoryAgent {
        ...
        memory_keys: &[],
        output_artifacts: &[],
        prompt_source_path: "docs2/gametheory/trust-game-analyst.md",
        tool_access: &[GameTheoryToolAccess::Read, GameTheoryToolAccess::Grep, GameTheoryToolAccess::Glob],
        model: "opus",
        condition: None,
        depends_on: &[],
    ...
    GameTheoryAgent {
        ...
        memory_keys: &[],
        output_artifacts: &[],
        prompt_source_path: "docs2/gametheory/ultimatum-bargainer.md",
        tool_access: &[GameTheoryToolAccess::Read, GameTheoryToolAccess::Grep, GameTheoryToolAccess::Glob],
        model: "opus",
        condition: None,
        depends_on: &[],
    ...
    GameTheoryAgent {
        ...
        memory_keys: &[],
        output_artifacts: &[],
        prompt_source_path: "docs2/gametheory/vcg-architect.md",
        tool_access: &[GameTheoryToolAccess::Read, GameTheoryToolAccess::Grep, GameTheoryToolAccess::Glob],
        model: "opus",
        condition: None,
        depends_on: &[],
    ...
    GameTheoryAgent {
        ...
        memory_keys: &[],
        output_artifacts: &[],
        prompt_source_path: "docs2/gametheory/voting-strategy-analyst.md",
        tool_access: &[GameTheoryToolAccess::Read, GameTheoryToolAccess::Grep, GameTheoryToolAccess::Glob],
        model: "opus",
        condition: None,
        depends_on: &[],
    ...
    GameTheoryAgent {
        ...
        memory_keys: &[],
        output_artifacts: &[],
        prompt_source_path: "docs2/gametheory/war-of-attrition-analyst.md",
        tool_access: &[GameTheoryToolAccess::Read, GameTheoryToolAccess::Grep, GameTheoryToolAccess::Glob],
        model: "opus",
        condition: None,
        depends_on: &[],
