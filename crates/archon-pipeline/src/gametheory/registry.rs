...
pub static GAMETHEORY_AGENTS: &[GameTheoryAgent] = &[
    GameTheoryAgent {
        ...
        tool_access: &[
            GameTheoryToolAccess::Read,
            GameTheoryToolAccess::Grep,
            GameTheoryToolAccess::Glob,
        ],
        model: "opus",
        condition: None,
        depends_on: &[],
    ...
    GameTheoryAgent {
        ...
        tool_access: &[
            ...
            GameTheoryToolAccess::Grep,
            GameTheoryToolAccess::Glob,
            GameTheoryToolAccess::WebSearch,
        ],
        model: "opus",
        condition: None,
        depends_on: &[],
    ...
    GameTheoryAgent {
        ...
        memory_keys: &["gametheory/situation"],
        output_artifacts: &["gametheory/tier1/fingerprint"],
        prompt_source_path: ".archon/agents/gametheory/game-classifier.md",
        tool_access: &[
            GameTheoryToolAccess::Read,
            GameTheoryToolAccess::Grep,
            GameTheoryToolAccess::Glob,
            GameTheoryToolAccess::WebFetch,
            GameTheoryToolAccess::WebSearch,
        ],
        model: "opus",
        condition: None,
    ...
    GameTheoryAgent {
        ...
        memory_keys: &["gametheory/situation"],
        output_artifacts: &["gametheory/tier1/information-structure"],
    ...
    GameTheoryAgent {
        ...
        memory_keys: &["gametheory/tier1/payoffs", "gametheory/tier1/strategies"],
        output_artifacts: &["gametheory/tier2/nash-equilibrium"],
    ...
    GameTheoryAgent {
        ...
        memory_keys: &["gametheory/situation"],
        output_artifacts: &["gametheory/tier1/payoffs"],
    ...
    GameTheoryAgent {
        ...
        memory_keys: &["gametheory/tier1/payoffs", "gametheory/tier1/strategies"],
        output_artifacts: &["gametheory/tier1/payoff-matrix"],
    ...
    GameTheoryAgent {
        ...
        memory_keys: &["gametheory/situation"],
        output_artifacts: &["gametheory/tier1/strategies"],
