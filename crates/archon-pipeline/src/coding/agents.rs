...
pub static AGENTS: &[CodingAgent] = &[
    ...
    CodingAgent {
        ...
        prompt_source_path: ".claude/agents/coding-pipeline/contract-agent.md",
    ...
    CodingAgent {
        ...
        phase: Phase::Understanding,
        model: "claude-sonnet-4-20250514",
        prompt_source_path: ".claude/agents/coding-pipeline/requirement-extractor.md",
        tool_access: ToolAccess::ReadOnly,
        algorithm: Algorithm::ToT,
        fallback_algorithm: Some(Algorithm::Reflexion),
    ...
    CodingAgent {
        ...
        phase: Phase::Understanding,
        model: "claude-sonnet-4-20250514",
        prompt_source_path: ".claude/agents/coding-pipeline/requirement-prioritizer.md",
        tool_access: ToolAccess::ReadOnly,
    ...
    CodingAgent {
        ...
        phase: Phase::Understanding,
        model: "claude-sonnet-4-20250514",
        prompt_source_path: ".claude/agents/coding-pipeline/scope-definer.md",
        tool_access: ToolAccess::ReadOnly,
        algorithm: Algorithm::ToT,
        fallback_algorithm: Some(Algorithm::ReAct),
    ...
    CodingAgent {
        ...
        phase: Phase::Understanding,
        model: "claude-sonnet-4-20250514",
        prompt_source_path: ".claude/agents/coding-pipeline/context-gatherer.md",
        tool_access: ToolAccess::ReadOnly,
    ...
    CodingAgent {
        ...
        phase: Phase::Design,
        model: "claude-sonnet-4-20250514",
        prompt_source_path: ".claude/agents/coding-pipeline/feasibility-analyzer.md",
        tool_access: ToolAccess::ReadOnly,
        algorithm: Algorithm::PoT,
        fallback_algorithm: Some(Algorithm::ReAct),
    ...
    CodingAgent {
        ...
        phase: Phase::Understanding,
        model: "claude-sonnet-4-20250514",
        prompt_source_path: ".claude/agents/coding-pipeline/pattern-explorer.md",
        tool_access: ToolAccess::ReadOnly,
    ...
    CodingAgent {
        ...
        phase: Phase::Understanding,
        model: "claude-sonnet-4-20250514",
        prompt_source_path: ".claude/agents/coding-pipeline/technology-scout.md",
        tool_access: ToolAccess::ReadOnly,
        algorithm: Algorithm::ReAct,
        fallback_algorithm: Some(Algorithm::Reflexion),
    ...
    CodingAgent {
        ...
        phase: Phase::Design,
        model: "claude-sonnet-4-20250514",
        prompt_source_path: ".claude/agents/coding-pipeline/research-planner.md",
        tool_access: ToolAccess::ReadOnly,
        algorithm: Algorithm::ToT,
        fallback_algorithm: Some(Algorithm::ReAct),
        depends_on: &["pattern-explorer"],
    ...
    CodingAgent {
        ...
        phase: Phase::Understanding,
        model: "claude-sonnet-4-20250514",
        prompt_source_path: ".claude/agents/coding-pipeline/codebase-analyzer.md",
        tool_access: ToolAccess::ReadOnly,
        algorithm: Algorithm::ReAct,
        fallback_algorithm: Some(Algorithm::Reflexion),
    ...
    CodingAgent {
        ...
        phase: Phase::Design,
        model: "claude-sonnet-4-20250514",
        prompt_source_path: ".claude/agents/coding-pipeline/phase-1-reviewer.md",
        tool_access: ToolAccess::ReadOnly,
    ...
    CodingAgent {
        ...
        phase: Phase::Design,
        model: "claude-sonnet-4-20250514",
        prompt_source_path: ".claude/agents/coding-pipeline/phase-2-reviewer.md",
        tool_access: ToolAccess::ReadOnly,
        algorithm: Algorithm::Reflexion,
        fallback_algorithm: Some(Algorithm::ToT),
    ...
    CodingAgent {
        ...
        phase: Phase::Design,
        model: "claude-sonnet-4-20250514",
        prompt_source_path: ".claude/agents/coding-pipeline/system-designer.md",
        tool_access: ToolAccess::ReadOnly,
        algorithm: Algorithm::ToT,
    ...
    CodingAgent {
        ...
        phase: Phase::Design,
        model: "claude-sonnet-4-20250514",
        prompt_source_path: ".claude/agents/coding-pipeline/component-designer.md",
        tool_access: ToolAccess::ReadOnly,
        algorithm: Algorithm::ToT,
        fallback_algorithm: Some(Algorithm::Reflexion),
    ...
    CodingAgent {
        ...
        phase: Phase::Design,
        model: "claude-sonnet-4-20250514",
        prompt_source_path: ".claude/agents/coding-pipeline/interface-designer.md",
        tool_access: ToolAccess::ReadOnly,
        algorithm: Algorithm::ToT,
        fallback_algorithm: Some(Algorithm::Reflexion),
    ...
    CodingAgent {
        ...
        phase: Phase::Design,
        model: "claude-sonnet-4-20250514",
        prompt_source_path: ".claude/agents/coding-pipeline/data-architect.md",
        tool_access: ToolAccess::ReadOnly,
        algorithm: Algorithm::ReAct,
    ...
    CodingAgent {
        ...
        model: "claude-sonnet-4-20250514",
        prompt_source_path: ".claude/agents/coding-pipeline/integration-architect.md",
        tool_access: ToolAccess::ReadOnly,
        algorithm: Algorithm::ToT,
        fallback_algorithm: Some(Algorithm::Reflexion),
    ...
    CodingAgent {
        ...
        phase: Phase::WiringPlan,
        model: "claude-sonnet-4-20250514",
        prompt_source_path: ".claude/agents/coding-pipeline/wiring-obligation-agent.md",
        tool_access: ToolAccess::ReadOnly,
        algorithm: Algorithm::ToT,
        fallback_algorithm: Some(Algorithm::ReAct),
    ...
    CodingAgent {
        ...
        phase: Phase::WiringPlan,
        model: "claude-sonnet-4-20250514",
        prompt_source_path: ".claude/agents/coding-pipeline/phase-3-reviewer.md",
        tool_access: ToolAccess::ReadOnly,
        algorithm: Algorithm::Reflexion,
        fallback_algorithm: Some(Algorithm::ToT),
    ...
    CodingAgent {
        ...
        model: "claude-sonnet-4-20250514",
        prompt_source_path: ".claude/agents/coding-pipeline/code-generator.md",
    ...
    CodingAgent {
        ...
        phase: Phase::Implementation,
        model: "claude-sonnet-4-20250514",
        prompt_source_path: ".claude/agents/coding-pipeline/type-implementer.md",
        tool_access: ToolAccess::Full,
        algorithm: Algorithm::SelfDebug,
        fallback_algorithm: Some(Algorithm::ReAct),
    ...
    CodingAgent {
        ...
        phase: Phase::Implementation,
        model: "claude-sonnet-4-20250514",
        prompt_source_path: ".claude/agents/coding-pipeline/unit-implementer.md",
        tool_access: ToolAccess::Full,
        algorithm: Algorithm::SelfDebug,
        fallback_algorithm: Some(Algorithm::Reflexion),
    ...
    CodingAgent {
        ...
        phase: Phase::Implementation,
        model: "claude-sonnet-4-20250514",
        prompt_source_path: ".claude/agents/coding-pipeline/service-implementer.md",
        tool_access: ToolAccess::Full,
        algorithm: Algorithm::LATS,
    ...
    CodingAgent {
        ...
        phase: Phase::Implementation,
        model: "claude-sonnet-4-20250514",
        prompt_source_path: ".claude/agents/coding-pipeline/data-layer-implementer.md",
        tool_access: ToolAccess::Full,
        algorithm: Algorithm::SelfDebug,
        fallback_algorithm: Some(Algorithm::ReAct),
        depends_on: &["unit-implementer"],
    ...
    CodingAgent {
        ...
        phase: Phase::Implementation,
        model: "claude-sonnet-4-20250514",
        prompt_source_path: ".claude/agents/coding-pipeline/api-implementer.md",
        tool_access: ToolAccess::Full,
        algorithm: Algorithm::ReAct,
        fallback_algorithm: Some(Algorithm::SelfDebug),
    ...
    CodingAgent {
        ...
        phase: Phase::Implementation,
        model: "claude-sonnet-4-20250514",
        prompt_source_path: ".claude/agents/coding-pipeline/frontend-implementer.md",
        tool_access: ToolAccess::Full,
        algorithm: Algorithm::SelfDebug,
        fallback_algorithm: Some(Algorithm::ReAct),
    ...
    CodingAgent {
        ...
        phase: Phase::Implementation,
        model: "claude-sonnet-4-20250514",
        prompt_source_path: ".claude/agents/coding-pipeline/error-handler-implementer.md",
        tool_access: ToolAccess::Full,
        algorithm: Algorithm::ReAct,
        fallback_algorithm: Some(Algorithm::Reflexion),
        depends_on: &["api-implementer"],
    ...
    CodingAgent {
        ...
        phase: Phase::Implementation,
        model: "claude-sonnet-4-20250514",
        prompt_source_path: ".claude/agents/coding-pipeline/config-implementer.md",
        tool_access: ToolAccess::Full,
        algorithm: Algorithm::ReAct,
        fallback_algorithm: Some(Algorithm::SelfDebug),
    ...
    CodingAgent {
        ...
        phase: Phase::Implementation,
        model: "claude-sonnet-4-20250514",
        prompt_source_path: ".claude/agents/coding-pipeline/logger-implementer.md",
        tool_access: ToolAccess::Full,
        algorithm: Algorithm::ReAct,
        fallback_algorithm: Some(Algorithm::SelfDebug),
    ...
    CodingAgent {
        ...
        phase: Phase::Implementation,
        model: "claude-sonnet-4-20250514",
        prompt_source_path: ".claude/agents/coding-pipeline/integration-verification-agent.md",
        tool_access: ToolAccess::ReadOnly,
        algorithm: Algorithm::ReAct,
    ...
    CodingAgent {
        ...
        model: "claude-sonnet-4-20250514",
        prompt_source_path: ".claude/agents/coding-pipeline/dependency-manager.md",
        tool_access: ToolAccess::Full,
        algorithm: Algorithm::ReAct,
        fallback_algorithm: Some(Algorithm::SelfDebug),
    ...
    CodingAgent {
        ...
        phase: Phase::Refinement,
        model: "claude-sonnet-4-20250514",
        prompt_source_path: ".claude/agents/coding-pipeline/implementation-coordinator.md",
        tool_access: ToolAccess::Full,
        algorithm: Algorithm::Reflexion,
        fallback_algorithm: Some(Algorithm::ReAct),
    ...
    CodingAgent {
        ...
        phase: Phase::Testing,
        model: "claude-sonnet-4-20250514",
        prompt_source_path: ".claude/agents/coding-pipeline/phase-4-reviewer.md",
        tool_access: ToolAccess::Full,
        algorithm: Algorithm::Reflexion,
        fallback_algorithm: Some(Algorithm::SelfDebug),
    ...
    CodingAgent {
        ...
        phase: Phase::Testing,
        model: "claude-sonnet-4-20250514",
        prompt_source_path: ".claude/agents/coding-pipeline/test-generator.md",
        tool_access: ToolAccess::Full,
        algorithm: Algorithm::ToT,
        fallback_algorithm: Some(Algorithm::SelfDebug),
    ...
    CodingAgent {
        ...
        phase: Phase::Testing,
        model: "claude-sonnet-4-20250514",
        prompt_source_path: ".claude/agents/coding-pipeline/test-runner.md",
        tool_access: ToolAccess::Full,
        algorithm: Algorithm::ReAct,
        fallback_algorithm: Some(Algorithm::SelfDebug),
    ...
    CodingAgent {
        ...
        phase: Phase::Testing,
        model: "claude-sonnet-4-20250514",
        prompt_source_path: ".claude/agents/coding-pipeline/integration-tester.md",
        tool_access: ToolAccess::Full,
        algorithm: Algorithm::SelfDebug,
        fallback_algorithm: Some(Algorithm::ReAct),
    ...
    CodingAgent {
        ...
        phase: Phase::Testing,
        model: "claude-sonnet-4-20250514",
        prompt_source_path: ".claude/agents/coding-pipeline/regression-tester.md",
        tool_access: ToolAccess::Full,
        algorithm: Algorithm::Reflexion,
        fallback_algorithm: Some(Algorithm::SelfDebug),
        depends_on: &["test-runner"],
    ...
    CodingAgent {
        ...
        phase: Phase::Testing,
        model: "claude-sonnet-4-20250514",
        prompt_source_path: ".claude/agents/coding-pipeline/security-tester.md",
        tool_access: ToolAccess::Full,
        algorithm: Algorithm::ReAct,
        fallback_algorithm: Some(Algorithm::Reflexion),
    ...
    CodingAgent {
        ...
        phase: Phase::Testing,
        model: "claude-sonnet-4-20250514",
        prompt_source_path: ".claude/agents/coding-pipeline/coverage-analyzer.md",
        tool_access: ToolAccess::Full,
        algorithm: Algorithm::PoT,
        fallback_algorithm: Some(Algorithm::ReAct),
    ...
    CodingAgent {
        ...
        phase: Phase::Refinement,
        model: "claude-sonnet-4-20250514",
        prompt_source_path: ".claude/agents/coding-pipeline/quality-gate.md",
        tool_access: ToolAccess::Full,
        algorithm: Algorithm::Reflexion,
        fallback_algorithm: Some(Algorithm::PoT),
    ...
    CodingAgent {
        ...
        phase: Phase::Testing,
        model: "claude-sonnet-4-20250514",
        prompt_source_path: ".claude/agents/coding-pipeline/test-fixer.md",
        tool_access: ToolAccess::Full,
        algorithm: Algorithm::SelfDebug,
        fallback_algorithm: Some(Algorithm::Reflexion),
    ...
    CodingAgent {
        ...
        phase: Phase::Testing,
        model: "claude-sonnet-4-20250514",
        prompt_source_path: ".claude/agents/coding-pipeline/phase-5-reviewer.md",
        tool_access: ToolAccess::Full,
        algorithm: Algorithm::Reflexion,
        fallback_algorithm: Some(Algorithm::SelfDebug),
    ...
    CodingAgent {
        ...
        phase: Phase::Refinement,
        model: "claude-sonnet-4-20250514",
        prompt_source_path: ".claude/agents/coding-pipeline/performance-optimizer.md",
        tool_access: ToolAccess::Full,
        algorithm: Algorithm::PoT,
        fallback_algorithm: Some(Algorithm::Reflexion),
    ...
    CodingAgent {
        ...
        phase: Phase::Design,
        model: "claude-sonnet-4-20250514",
        prompt_source_path: ".claude/agents/coding-pipeline/performance-architect.md",
        tool_access: ToolAccess::ReadOnly,
        algorithm: Algorithm::ToT,
        fallback_algorithm: Some(Algorithm::ReAct),
    ...
    CodingAgent {
        ...
        phase: Phase::Refinement,
        model: "claude-sonnet-4-20250514",
        prompt_source_path: ".claude/agents/coding-pipeline/code-quality-improver.md",
        tool_access: ToolAccess::Full,
        algorithm: Algorithm::Reflexion,
        fallback_algorithm: Some(Algorithm::ReAct),
        depends_on: &["performance-optimizer"],
    ...
    CodingAgent {
        ...
        phase: Phase::Design,
        model: "claude-sonnet-4-20250514",
        prompt_source_path: ".claude/agents/coding-pipeline/security-architect.md",
        tool_access: ToolAccess::ReadOnly,
        algorithm: Algorithm::ReAct,
        fallback_algorithm: Some(Algorithm::Reflexion),
    ...
    CodingAgent {
        ...
        phase: Phase::Refinement,
        model: "claude-sonnet-4-20250514",
        prompt_source_path: ".claude/agents/coding-pipeline/final-refactorer.md",
        tool_access: ToolAccess::Full,
        algorithm: Algorithm::Reflexion,
        fallback_algorithm: Some(Algorithm::SelfDebug),
    ...
    CodingAgent {
        ...
        phase: Phase::Refinement,
        model: "claude-sonnet-4-20250514",
        prompt_source_path: ".claude/agents/coding-pipeline/sign-off-approver.md",
        tool_access: ToolAccess::Full,
        algorithm: Algorithm::Reflexion,
        fallback_algorithm: Some(Algorithm::ReAct),
    ...
    CodingAgent {
        ...
        phase: Phase::Refinement,
        model: "claude-sonnet-4-20250514",
        prompt_source_path: ".claude/agents/coding-pipeline/phase-6-reviewer.md",
        tool_access: ToolAccess::Full,
        algorithm: Algorithm::Reflexion,
        fallback_algorithm: Some(Algorithm::ToT),
    ...
    CodingAgent {
        ...
        phase: Phase::Refinement,
        model: "claude-sonnet-4-20250514",
        prompt_source_path: ".claude/agents/coding-pipeline/recovery-agent.md",
        tool_access: ToolAccess::Full,
        algorithm: Algorithm::Reflexion,
        fallback_algorithm: Some(Algorithm::LATS),
