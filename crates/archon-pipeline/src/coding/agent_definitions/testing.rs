...
pub(super) const PHASE_4_REVIEWER: CodingAgent = CodingAgent {
...
pub(super) const TEST_GENERATOR: CodingAgent = CodingAgent {
        key: "test-generator",
        phase: Phase::Testing,
        model: "sonnet",
...
pub(super) const TEST_RUNNER: CodingAgent = CodingAgent {
        key: "test-runner",
        phase: Phase::Testing,
        model: "sonnet",
...
pub(super) const INTEGRATION_TESTER: CodingAgent = CodingAgent {
...
pub(super) const REGRESSION_TESTER: CodingAgent = CodingAgent {
...
pub(super) const SECURITY_TESTER: CodingAgent = CodingAgent {
        key: "security-tester",
        phase: Phase::Testing,
        model: "sonnet",
...
pub(super) const COVERAGE_ANALYZER: CodingAgent = CodingAgent {
...
pub(super) const TEST_FIXER: CodingAgent = CodingAgent {
        key: "test-fixer",
        phase: Phase::Testing,
        model: "sonnet",
...
pub(super) const PHASE_5_REVIEWER: CodingAgent = CodingAgent {
