...
pub(in super::super) const CODE_GENERATOR: CodingAgent = CodingAgent {
    key: "code-generator",
...
pub(in super::super) const TYPE_IMPLEMENTER: CodingAgent = CodingAgent {
...
pub(in super::super) const UNIT_IMPLEMENTER: CodingAgent = CodingAgent {
...
pub(in super::super) const SERVICE_IMPLEMENTER: CodingAgent = CodingAgent {
...
pub(in super::super) const DATA_LAYER_IMPLEMENTER: CodingAgent = CodingAgent {
...
pub(in super::super) const API_IMPLEMENTER: CodingAgent = CodingAgent {
    key: "api-implementer",
    phase: Phase::Implementation,
    model: "sonnet",
...
pub(in super::super) const FRONTEND_IMPLEMENTER: CodingAgent = CodingAgent {
...
pub(in super::super) const ERROR_HANDLER_IMPLEMENTER: CodingAgent = CodingAgent {
...
pub(in super::super) const CONFIG_IMPLEMENTER: CodingAgent = CodingAgent {
...
pub(in super::super) const LOGGER_IMPLEMENTER: CodingAgent = CodingAgent {
...
pub(in super::super) const INTEGRATION_VERIFICATION_AGENT: CodingAgent = CodingAgent {
