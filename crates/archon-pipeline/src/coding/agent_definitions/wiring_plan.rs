...
pub(super) const INTEGRATION_ARCHITECT: CodingAgent = CodingAgent {
...
pub(super) const WIRING_OBLIGATION_AGENT: CodingAgent = CodingAgent {
...
pub(super) const PHASE_3_REVIEWER: CodingAgent = CodingAgent {
