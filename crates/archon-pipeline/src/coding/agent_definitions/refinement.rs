...
pub(super) const DEPENDENCY_MANAGER: CodingAgent = CodingAgent {
...
pub(super) const IMPLEMENTATION_COORDINATOR: CodingAgent = CodingAgent {
...
pub(super) const QUALITY_GATE: CodingAgent = CodingAgent {
        key: "quality-gate",
        phase: Phase::Refinement,
        model: "sonnet",
...
pub(super) const PERFORMANCE_OPTIMIZER: CodingAgent = CodingAgent {
...
pub(super) const CODE_QUALITY_IMPROVER: CodingAgent = CodingAgent {
...
pub(super) const FINAL_REFACTORER: CodingAgent = CodingAgent {
...
pub(super) const SIGN_OFF_APPROVER: CodingAgent = CodingAgent {
...
pub(super) const PHASE_6_REVIEWER: CodingAgent = CodingAgent {
...
pub(super) const RECOVERY_AGENT: CodingAgent = CodingAgent {
        key: "recovery-agent",
        phase: Phase::Refinement,
        model: "sonnet",
