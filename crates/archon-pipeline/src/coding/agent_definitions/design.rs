...
pub(super) const FEASIBILITY_ANALYZER: CodingAgent = CodingAgent {
...
pub(super) const RESEARCH_PLANNER: CodingAgent = CodingAgent {
...
pub(super) const PHASE_1_REVIEWER: CodingAgent = CodingAgent {
...
pub(super) const PHASE_2_REVIEWER: CodingAgent = CodingAgent {
...
pub(super) const SYSTEM_DESIGNER: CodingAgent = CodingAgent {
        key: "system-designer",
        phase: Phase::Design,
        model: "sonnet",
...
pub(super) const COMPONENT_DESIGNER: CodingAgent = CodingAgent {
...
pub(super) const INTERFACE_DESIGNER: CodingAgent = CodingAgent {
...
pub(super) const DATA_ARCHITECT: CodingAgent = CodingAgent {
        key: "data-architect",
        phase: Phase::Design,
        model: "sonnet",
...
pub(super) const PERFORMANCE_ARCHITECT: CodingAgent = CodingAgent {
...
pub(super) const SECURITY_ARCHITECT: CodingAgent = CodingAgent {
