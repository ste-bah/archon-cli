...
pub(in super::super) const CONTRACT_AGENT: CodingAgent = CodingAgent {
    key: "contract-agent",
...
pub(in super::super) const REQUIREMENT_EXTRACTOR: CodingAgent = CodingAgent {
...
pub(in super::super) const REQUIREMENT_PRIORITIZER: CodingAgent = CodingAgent {
...
pub(in super::super) const SCOPE_DEFINER: CodingAgent = CodingAgent {
    key: "scope-definer",
    phase: Phase::Understanding,
    model: "sonnet",
...
pub(in super::super) const CONTEXT_GATHERER: CodingAgent = CodingAgent {
...
pub(in super::super) const PATTERN_EXPLORER: CodingAgent = CodingAgent {
...
pub(in super::super) const TECHNOLOGY_SCOUT: CodingAgent = CodingAgent {
...
pub(in super::super) const CODEBASE_ANALYZER: CodingAgent = CodingAgent {
