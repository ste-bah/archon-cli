...
//! Milestone 4 adds three more — [`diamond`], [`fake_edges`], [`fusion`] — and
//! they are **advisory**. They report and explain; none of them can block a
