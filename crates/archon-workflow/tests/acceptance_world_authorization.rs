...
fn reference() -> FrozenCommandRef {
    FrozenCommandRef {
        ...
        chain_digest: "bound-chain".into(),
        command_digest: content_digest(b"./verify-output"),
    }
}
#[test]
