...
#[test]
fn generated_final_gate_infers_required_artifacts_from_prd_layout() {
    ...
    assert_contains(&artifacts, ".archon/trading-lab/data/registry.json");
    assert_contains(
        &artifacts,
        ".archon/trading-lab/data/provider-capabilities.json",
    );
    assert_contains(&artifacts, ".archon/trading-lab/data/coverage/latest.json");
    assert_contains(&artifacts, ".archon/trading-lab/data/coverage/latest.md");
    assert_contains(
        &artifacts,
