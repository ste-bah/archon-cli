...
/// blocks, to the dedent), comments and literal contents excluded — read
/// from a syntax tree where a grammar exists (`code_hygiene::tree_scan`),
/// else by the hand scanner. Like the line cap it is a ratchet (`code_hygiene::complexity_ratchet`): a function already over
