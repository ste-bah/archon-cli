...
fn provider_remediation_requires_host_grounded_redacted_proof() {
    let prompt = crate::v2::lifecycle_prompts::VERIFICATION_REMEDIATION_WAVE_TASK;
...
fn d45_keyless_and_or_unavailable_contracts_are_accepted_at_source() {
    let prompts = [
        ...
        crate::v2::lifecycle_prompts::VERIFICATION_WAVE_TASK,
        crate::v2::lifecycle_prompts::VERIFICATION_REMEDIATION_WAVE_TASK,
    ];
...
fn d48_d49_verifier_prompts_search_branch_proofs_and_follow_manifest_pointer() {
    let prompts = [
        ...
        crate::v2::lifecycle_prompts::VERIFICATION_WAVE_TASK,
        crate::v2::lifecycle_prompts::RETRY_VERIFICATION_WAVE_TASK,
        crate::v2::lifecycle_prompts::FINAL_EVIDENCE_RECONCILIATION_TASK,
        crate::v2::lifecycle_prompts::FINAL_ZERO_GAP_AUDIT_TASK,
    ];
