...
| `archon-pipeline` | 50-agent coding pipeline, 47-agent research pipeline, audited bundles, game-theory pipeline, learning systems |
...
- [Pipelines](pipelines.md) — 50-agent coding + 47-agent research orchestration with audited run bundles
