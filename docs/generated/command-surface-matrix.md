...
| `archon self ...` | - | Calibration shell | SHELL_ONLY | `src/cli_args.rs + src/command/self_calibration.rs` | Retrospective, self-trust, and plan-vs-outcome inspection are shell-first calibration tools. | Self-calibration is intentionally shell-first until retrospective review has a dedicated TUI inspector.; owner: archon-maintainers; review: 2026-09-30 |
