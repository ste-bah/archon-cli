...
- `cargo test -p archon-trading ahdm_citation_artifact_shape` — citation artifact shape, for the artifacts this task generates by code.
- `cargo test -p archon-trading ahdm_rule_inventory_validation` — rule inventory validation.
