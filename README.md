...
- Current version: **v1.3.0** ([release notes](docs/release-notes/v1.3.0.md))
...
- v1.3.0 removes model-facing `max_turns` from subagent tool schemas, preserves actual subagent model metadata in the foreground activity stream, and shows context-window status before first token usage.
