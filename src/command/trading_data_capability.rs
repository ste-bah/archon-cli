...
pub(super) fn capability(
    ...
    let result = if matches!(provider_key.as_str(), "openbb" | "polygon" | "yfinance") {
        ...
        crate::command::trading_data_provider_openbb::probe_capability_with_base_url(
            lake.project_root(),
            &base_url,
            provider,
            symbol,
    ...
    let report = json!({
        ...
        "provider_environment": super::trading_data_env::provider_environment_status(provider),
