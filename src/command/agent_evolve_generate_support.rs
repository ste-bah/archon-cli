//! Conversion helpers for governed agent evolution proposal generation.

use chrono::{DateTime, Utc};
use sha2::{Digest, Sha256};

pub(super) fn ledger_record_to_event(
...
pub(super) fn proposal_to_record(
...
pub(super) fn proposal_fingerprint(
...
pub(super) fn proposal_kind_str(
...
pub(super) fn risk_level_str(
    level: archon_core::agents::evolution::AgentEvolutionRiskLevel,
) -> &'static str {
    match level {
