...
pub(crate) use guard::{
    ...
    begin_guarded_action, forced_repair_prompt, reclassify_active_guardrail_for_session,
...
pub(crate) use trainer_runtime::{
    latest_daemon_trainer_event, run_daemon_trainer_tick_controlled, schedule_dynamic_trainer_tick,
};
